...
const ALL_MARKETPLACES: Record<string, MarketplaceDef> = {
  ...
  'The RealReal':    { color:'#c9a96e', bg:'rgba(201,169,110,0.08)', urlFn: q => `https://www.therealreal.com/search?q=${q}`, desc:'Luxury consignment', categories:['Fashion','Watches','Art'] },
  'Grailed':         { color:'#e0e0e0', bg:'rgba(224,224,224,0.06)', urlFn: q => `https://www.grailed.com/shop?query=${q}`, desc:"Men's fashion & streetwear", categories:['Fashion'] },
  'Vestiaire':       { color:'#8bc6a3', bg:'rgba(139,198,163,0.08)', urlFn: q => `https://www.vestiairecollective.com/search/?q=${q}`, desc:'Designer resale', categories:['Fashion','Watches'] },
  ...
  'Card Kingdom':    { color:'#5d8aa8', bg:'rgba(44,62,80,0.08)', urlFn: q => `https://www.cardkingdom.com/catalog/search?search=header&filter%5Bname%5D=${q}`, desc:'Magic: The Gathering', categories:['Trading Cards'] },
  'Discogs':         { color:'#d48806', bg:'rgba(212,136,6,0.08)', urlFn: q => `https://www.discogs.com/search/?q=${q}&type=all`, desc:'Vinyl & music marketplace', categories:['Vinyl & Music','Vinyl','Collectibles'] },
