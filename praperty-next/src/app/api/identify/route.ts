...
const CATEGORY_HINT_LABELS: Record<string, string> = {
  ...
  vinyl: 'Vinyl record or record player',
  radios: 'Radio or vintage audio equipment',
  electronics: 'Electronics (phones, tablets, computers, etc.)',
  jewelry: 'Jewelry (rings, necklaces, bracelets, etc.)',
  perfume: 'Perfume, fragrance, or scent product',
  comic_books: 'Comic book or graphic novel',
  trading_cards: 'Trading cards (e.g. Pokémon, sports cards)',
  home_goods: 'Home goods (kitchen, decor, etc.)',
  furniture: 'Furniture',
  watches: 'Watch or timepiece',
  bags: 'Bag, backpack, or luggage',
  books: 'Book or printed material',
  instruments: 'Musical instrument',
  gaming: 'Gaming console, game, or accessory',
  sports: 'Sports equipment or memorabilia',
  toys: 'Toy or collectible toy',
  tools: 'Tool or hardware',
  collectibles: 'Collectible item',
